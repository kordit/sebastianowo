        ...
        return array(
            ...
            'layouts' => array(
                ...
                'layout_condition_mission' => array(
                    ...
                    'sub_fields' => array(
                        array(
                            'key' => 'field_visibility_mission_condition',
                            'label' => 'Warunek',
                            'name' => 'condition',
                            'type' => 'select',
                            'instructions' => '',
                        ...
                        array(
                            'key' => 'field_visibility_mission_select',
                            'label' => 'Wybierz misję',
                            'name' => 'mission_id',
                            'type' => 'post_object',
                            'instructions' => '',
                        ...
                        array(
                            'key' => 'field_visibility_mission_status',
                            'label' => 'Status misji',
                            'name' => 'status',
                            'type' => 'select',
                            'instructions' => '',
                ...
                'layout_condition_task' => array(
                    ...
                    'sub_fields' => array(
                        array(
                            'key' => 'field_visibility_task_condition',
                            'label' => 'Warunek',
                            'name' => 'condition',
                            'type' => 'select',
                            'instructions' => '',
                        ...
                        array(
                            'key' => 'field_visibility_task_mission',
                            'label' => 'Wybierz misję',
                            'name' => 'mission_id',
                            'type' => 'post_object',
                            'instructions' => '',
                        ...
                        array(
                            'key' => 'field_visibility_task_id',
                            'label' => 'ID zadania',
                            'name' => 'task_id',
                            'type' => 'text',
                            'instructions' => 'Podaj ID zadania z wybranej misji',
                            'required' => 0,
                            'wrapper' => array(
                                'width' => '30',
                                'class' => '',
                        ...
                        array(
                            'key' => 'field_visibility_task_status',
                            ...
                            'choices' => array(
                                ...
                                'completed' => 'Ukończone',
                                'failed' => 'Nieudane',
                                'completed_npc' => 'Zaliczone przez NPC',
                                'failed_npc' => 'Oblane przez NPC',
                                'progress_npc' => 'W trakcie przez NPC',
                                'not_started_npc' => 'Nierozpoczęte przez NPC',
                            ),
                            'default_value' => 'in_progress',
                            'allow_null' => 0,
                            'multiple' => 0,
