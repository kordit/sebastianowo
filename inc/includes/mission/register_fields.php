                        ...
                        'layouts' => array(
                            ...
                            'layout_relation_with_npc' => array(
                                ...
                                'sub_fields' => array(
                                    ...
                                    array(
                                        'key' => 'field_npc_relation_operator',
                                        'label' => 'Operator',
                            ...
                            // Warunek: Przeprowadź dialog
                            'layout_have_dialog' => array(
                                'key' => 'layout_have_dialog',
                                'name' => 'have_dialog',
                                'label' => 'Przeprowadź dialog',
                                'display' => 'block',
                                'sub_fields' => array(
                                    array(
                                        'key' => 'field_dialog_npc_ids',
                                        'label' => 'NPC do dialogu',
                                        'name' => 'npc_ids',
                                        'type' => 'post_object',
                                        'required' => 1,
                                        'post_type' => array('npc'),
                                        'return_format' => 'id',
                                        'multiple' => 1,
                                        'instructions' => 'Wybierz NPC, z którymi należy przeprowadzić dialog',
                                    ),
                                    array(
                                        'key' => 'field_dialog_count',
                                        'label' => 'Liczba wymaganych dialogów',
                                        'name' => 'dialog_count',
                                        'type' => 'number',
                                        'required' => 1,
                                        'default_value' => 1,
                                        'min' => 1,
                                        'instructions' => 'Liczba dialogów, które gracz musi przeprowadzić (np. "zachęć 5 osób")',
                                    ),
                                    array(
                                        'key' => 'field_dialog_task_name',
                                        'label' => 'Nazwa zadania dialogowego',
                                        'name' => 'dialog_task_name',
                                        'type' => 'text',
                                        'required' => 1,
                                        'default_value' => 'Przeprowadź dialog',
                                        'instructions' => 'Nazwa zadania wyświetlana graczowi, np. "Zachęć do głosowania"',
                                    ),
                                ),
                            ),
                        ),
